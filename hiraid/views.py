...
class Views:
    ...
    def gethostgrpdetail_default(self,metaview,default_view_keyname: str='_ports'):
        view = {}
        for port in metaview['data']:
            view[port] = { '_host_grps': {}, '_unused_host_grps': {}, '_unused_host_grps_by_rgid': {}}
            for gid in metaview['data'][port]:
                if metaview['data'][port][gid]['GROUP_NAME'] != "-":
                    view[port]['_host_grps'][gid] = {}
                    for heading in metaview['data'][port][gid]:
                        view[port]['_host_grps'][gid][heading] = metaview['data'][port][gid][heading]
                else:
                    view[port]['_unused_host_grps'][gid] = {}
                    for heading in metaview['data'][port][gid]:
                        view[port]['_unused_host_grps'][gid][heading] = metaview['data'][port][gid][heading]

                    view[port]['_unused_host_grps_by_rgid'][metaview['data'][port][gid]['RGID']] = view[port]['_unused_host_grps_by_rgid'].get(metaview['data'][port][gid]['RGID'],{})
                    view[port]['_unused_host_grps_by_rgid'][metaview['data'][port][gid]['RGID']][gid] = {}

                    for heading in metaview['data'][port][gid]:
                         view[port]['_unused_host_grps_by_rgid'][metaview['data'][port][gid]['RGID']][gid][heading] = metaview['data'][port][gid][heading]
    ...
    def getldev_default(self,metaview,default_view_keyname: str='_ldevs'):
        view = {}
        for ldevid in metaview['data']:
            view[ldevid] = metaview['data'][ldevid]
    ...
    def getsnapshot_default(self, metaview, default_view_keyname: str='_snapshot'):
        view = {}
        view[default_view_keyname] = metaview['data']
        self.log.debug("view: {}, default_view_keyname {}".format(view,default_view_keyname))
        self.updateview(self.storage.views,view)
    ...
    def getsnapshotgroup_default(self, metaview, default_view_keyname: str='_snapshot'):
        view = {}
        view[default_view_keyname] = metaview['data']
        self.log.debug("view: {}, default_view_keyname {}".format(view,default_view_keyname))
        self.updateview(self.storage.views,view)
